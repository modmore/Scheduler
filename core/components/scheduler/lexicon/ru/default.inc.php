...
$_lang['scheduler.filter_namespace...'] = "Фильтр по namespace";
...
$_lang['scheduler.content.file_desc'] = "Введите путь к файлу, который нужно запустить. Путь должен быть относительно core для выбранного namespace.";
...
$_lang['scheduler.content.processor_desc'] = "Введите название процессора, который будет выполнен при каждом запуске. Относительно папки процессора для выбранного namespace и без расширения (.class).php.";
